  ...
  return (
    <div className="home">
      <div style={{ flex: 1 }}>
        ...
        ברוכים הבאים לסוף הטוב. באתר תמצאו תכנים הנוגעים בתקופה עדינה ועמוקה של סוף החיים. 
        <br />
        מאמרים שכתבתי מתוך העבודה שלי כאחות הוספיס בית שם אני זוכה להיות חלק ממכלול שלם של מרחב הנוצר עבור אדם שהגיע לימיו האחרונים.
        <br />
        הרצאות העוסקות בסוף החיים כמרחב מעצים לחיים, ספרות רלוונטית וטקסטים שכתבו האנשים עצמם הנמצאים על הסף. 
        <br />
        קבלת המוות מאפשרת לנו קיום נינוח יותר בחיים עצמם. 
        <br />
        מאחלת לכם להתרווח, לקחת נשימה ולהסכים להנגע עד עמקי נשמתכם,
        <br />
        עינת
