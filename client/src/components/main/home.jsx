    ...
    <div className="home">
      <div style={{ flex: 1 }}>
        ...
        <h2 className="home-description">
          ברוכים הבאים לסוף הטוב. באתר תמצאו תכנים הנוגעים בתקופה עדינה ועמוקה
          של סוף החיים. מאמרים שכתבה עינת, כאחות הוספיס בית שזכתה להיות חלק
          ממכלול שלם של מרחב הנוצר עבור אדם שהגיע לימיו האחרונים. הרצאות העוסקות
          בסוף החיים כמרחב מעצים לחיים, ספרות רלוונטית וטקסטים שכתבו האנשים עצמם
          הנמצאים על הסף. קבלת המוות מאפשרת לנו קיום מרווח יותר בחיים עצמם.
          מאחלת לכם להתרווח, לקחת נשימה ולהסכים להנגע עד עמקי נשמתכם, עינת
        </h2>
      </div>
      <div style={{ flex: 1 }}>
        {user.role === "admin" ? (
